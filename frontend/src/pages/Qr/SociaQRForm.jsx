      ...
      >
        <div className="row mt-3">
          <div className="col-md-8 mx-auto d-flex">
            <button
              className={`btn top-buttons ${
                activeButton === "text" ? "active" : ""
              }`}
              onClick={() => handleButtonClick("text")}
            >
              <Link to="/qrs" className="text-decoration-none button-text">
                Text
              </Link>
            </button>
            ...
            <button
              className={`btn top-buttons ${
                activeButton === "url" ? "active" : ""
              }`}
              onClick={() => handleButtonClick("url")}
            >
              <Link to="/urls" className="text-decoration-none button-text">
                URL
              </Link>
            </button>
            ...
            <button
              className={`btn top-buttons ${
                activeButton === "user-details" ? "active" : ""
              }`}
              onClick={() => handleButtonClick("user-details")}
            >
              <Link
                to="/user-details"
                className="text-decoration-none button-text"
              >
                User Details
              </Link>
            </button>
            ...
            >
              <Link to="/location" className="text-decoration-none button-text">
                Location
              </Link>
            </button>
            ...
            <button
              className={`btn top-buttons ${
                activeButton === "socialmedia" ? "active" : ""
              }`}
                ...
                <form className="form">
                  <div className="py-3 mx-5">
                    <input
                      type="text"
                      name="name"
                      placeholder="Type your social media Link here."
                      id="qrText"
                      required
